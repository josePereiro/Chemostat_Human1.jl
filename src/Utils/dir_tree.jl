...
const DATA_DIR = joinpath(PROJ_ROOT, "data")
    const RAW_DATA_DIR = joinpath(DATA_DIR, "raw")
        const HUMAN1_PUBLICATION_RAW_DATA_DIR = joinpath(RAW_DATA_DIR, HUMAN1_PUBLICATION_PROJ_NAME)
        const HUMAN1_PUBLICATION_ZIP_FILE = joinpath(RAW_DATA_DIR, "$HUMAN1_PUBLICATION_PROJ_NAME.zip")
